    ...
    <MDBFooter className='bg-primary text-center text-white'>
      <MDBContainer className='p-4 pb-0'>
        ...
        <a className='btn btn-outline-light btn-floating m-1' href="https://www.linkedin.com/in/best-poovarasan-3732a6169/" target="_blank" role='button'>
          ...
          <a className='btn btn-outline-light btn-floating m-1' href="https://twitter.com/BestPoovarasan" target="_blank" role='button'>
            <MDBIcon fab icon='twitter' />
          </a>

          <a className='btn btn-outline-light btn-floating m-1' href="https://www.instagram.com/poovarasan.official/" target="_blank" role='button'>
